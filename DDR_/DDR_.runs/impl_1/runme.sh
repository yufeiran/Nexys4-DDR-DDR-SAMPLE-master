...
HD_PWD='C:/Users/Administrator/Desktop/Nexys4-DDR-DDR-SAMPLE-master/DDR_/DDR_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDR2.tcl -notrace
