...
HD_PWD='C:/Users/Administrator/Desktop/Nexys4-DDR-DDR-SAMPLE-master/DDR_/DDR_.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR2.tcl
